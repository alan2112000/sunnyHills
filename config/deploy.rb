...
role :web, "sunnyHills.com"                          # Your HTTP server, Apache/etc
role :app, "sunnyHills.com"                         # This may be the same as your `Web` server
role :db,  "sunnyHills.com"   , :primary => true # This is where Rails migrations will run
